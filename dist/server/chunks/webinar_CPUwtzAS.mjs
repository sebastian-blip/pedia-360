...
import 'piccolore';
import { m as maybeRenderHead, j as renderComponent, r as renderTemplate, f as addAttribute } from './server_wOc8bkzF.mjs';
...
const $$Webinar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$HeroWebinar, {})} ${renderComponent($$result2, "Features", $$FeaturesWebinar, {})} ${renderComponent($$result2, "Rutas", $$Rutas, {})} ${renderComponent($$result2, "FAQ", $$FAQ, {})} ${renderComponent($$result2, "FinalCTA", $$FinalCTA, {})} ` })}`;
