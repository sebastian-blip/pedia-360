...
import 'piccolore';
import { m as maybeRenderHead, j as renderComponent, r as renderTemplate, f as addAttribute } from './server_B64o-LQ9.mjs';
...
const $$FeaturesWebinar = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="features" data-astro-cid-a5dfepxp> <div class="features-container" data-astro-cid-a5dfepxp> <h2 data-astro-cid-a5dfepxp>Todo lo que tendrás dentro de la membresía</h2> <div class="features-grid" data-astro-cid-a5dfepxp> ${features.map((feature) => renderTemplate`<div class="feature-card" data-astro-cid-a5dfepxp> <div class="feature-icon" data-astro-cid-a5dfepxp> <img${addAttribute(feature.icon, "src")}${addAttribute(feature.title, "alt")} data-astro-cid-a5dfepxp> </div> <h3 data-astro-cid-a5dfepxp>${feature.title}</h3> <p data-astro-cid-a5dfepxp>${feature.description}</p> </div>`)} </div> </div> </section> <section class="unirme" data-astro-cid-a5dfepxp> <div class="hero-cta" data-astro-cid-a5dfepxp> ${renderComponent($$result, "Button", $$Button, { "text": "QUIERO UNIRME AHORA", "variant": "primary", "size": "lg", "href": "https://pay.hotmart.com/G106540717U?off=16kxvq3", "onClick": "gtag('event', 'webinar_cta_click', { event_category: 'engagement', event_label: 'Hero Section' });", "data-astro-cid-a5dfepxp": true })} </div> </section>`;
...
const $$CTAWebinar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="final-cta" data-astro-cid-hjpet6ht> <div class="final-container" data-astro-cid-hjpet6ht> <!-- Mensaje principal --> <div class="final-content" data-astro-cid-hjpet6ht> <h2 data-astro-cid-hjpet6ht>
Tu hijo no viene con manual…
<span class="highlight" data-astro-cid-hjpet6ht>pero no tienes que vivir este proceso sola.</span> </h2> <p data-astro-cid-hjpet6ht>Tener claridad y acompañamiento puede hacer una diferencia enorme en cómo vives cada etapa de la crianza.</p> </div> <!-- Botón grande final --> <div class="final-button" data-astro-cid-hjpet6ht> ${renderComponent($$result, "Button", $$Button, { "text": "QUIERO UNIRME A LA MEMBRESÍA AHORA", "variant": "primary", "href": "https://pay.hotmart.com/G106540717U?off=16kxvq3", "onClick": "gtag('event', 'final_cta_click', { event_category: 'engagement', event_label: 'Final CTA Section' });", "data-astro-cid-hjpet6ht": true })} </div> </div> </section>`;
}, "/home/sebastian-betancourh/Documentos/PEDIA 360 - ARCHIVOS-20260513T153510Z-3-001/landings/pedia360-landing/src/components/webinar/CTAWebinar.astro", void 0);

const $$Webinar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$HeroWebinar, {})} ${renderComponent($$result2, "Features", $$FeaturesWebinar, {})} ${renderComponent($$result2, "Rutas", $$Rutas, {})} ${renderComponent($$result2, "FAQ", $$FAQ, {})} ${renderComponent($$result2, "FinalCTA", $$CTAWebinar, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
